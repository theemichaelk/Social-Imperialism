...
const FEATURES = [
  ...
  { area: 'Step 4', name: 'Save auto-search settings', channel: 'save-auto-search-settings',
    ...
    validate: (d) => d?.success !== false || typeof d === 'object' },
  { area: 'Step 4', name: 'Discover keyword targets', channel: 'discover-keyword-targets',
    args: [{ keywords: ['saas marketing'], platform: 'All', limit: 15 }],
    validate: (d) => d?.success !== false && Array.isArray(d?.targets) },
