...
const SECTIONS = [
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'Sovereign status', channel: 'get-sovereign-threat-status', validate: (d) => d?.enabled === true && d?.adminIdentity === 'THEE_MICHAEL' },
      { name: 'Sovereign scan', channel: 'run-sovereign-threat-scan', validate: (d) => d?.success === true && d?.domain === 'socialimperialism.com' },
