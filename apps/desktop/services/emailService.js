...
<p>— Social Imperialism</p>`,
    ...
    {
      id: 'email_camp_subscriber_welcome',
      name: 'New Subscriber Welcome',
      description: 'Fires when a client completes subscription checkout (mirrors SaaS nurture Day 0).',
      provider: 'auto',
      trigger: 'subscriber.checkout',
      enabled: true,
      autoReply: true,
      shortenLinks: true,
      subject: 'Welcome to Social Imperialism — set your password',
      html: `<p>Hi,</p>
<p>Your subscription is active. Set your password and open the Setup Wizard to connect accounts and keywords.</p>
<p><a href="{{dashboardUrl}}">Open dashboard</a></p>`,
      createdAt: new Date().toISOString(),
    },
    {
      id: 'email_camp_subscriber_day3_tips',
      name: 'Subscriber Day 3 — Browse & Reply',
      description: 'Nurture tip: discover posts and draft AI replies.',
      provider: 'auto',
      trigger: 'subscriber.day3',
      enabled: true,
      autoReply: true,
      shortenLinks: true,
      subject: '{{brandName}} tip: Browse Posts + AI Replies',
      html: `<p>Quick win: open Browse Posts, filter by keyword, and draft your first AI reply mentioning <strong>{{brandName}}</strong>.</p>
<p><a href="{{dashboardUrl}}">Open AI Replies</a></p>`,
      createdAt: new Date().toISOString(),
    },
    {
      id: 'email_camp_subscriber_day7_content',
      name: 'Subscriber Day 7 — Content Hub',
      description: 'Nurture tip: schedule your first week of content.',
      provider: 'auto',
      trigger: 'subscriber.day7',
      enabled: true,
      autoReply: true,
      shortenLinks: true,
      subject: '{{brandName}} tip: Schedule a week of content',
      html: `<p>Use Content Hub to draft posts, attach media, and schedule across connected accounts.</p>
<p><a href="{{dashboardUrl}}">Open Content Hub</a></p>`,
      createdAt: new Date().toISOString(),
    },
    {
      id: 'email_camp_subscriber_day14_automation',
      name: 'Subscriber Day 14 — Auto-Rules',
      description: 'Nurture tip: enable be-first-to-reply automation.',
      provider: 'auto',
      trigger: 'subscriber.day14',
      enabled: true,
      autoReply: true,
      shortenLinks: true,
      subject: '{{brandName}} tip: Turn on Auto-Rules',
      html: `<p>Enable Auto-Rules to watch keywords and be first to reply on high-intent posts.</p>
<p><a href="{{dashboardUrl}}">Configure Auto-Rules</a></p>`,
      createdAt: new Date().toISOString(),
    },
  ].map((c) => ({
    ...c,
