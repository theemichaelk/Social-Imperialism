...
const ENV_ALIASES = {
  ...
  siSerpBaseUrl: ['SI_SERP_BASE_URL', 'OPENSERP_BASE_URL', 'OPEN_SERP_BASE_URL'],
  siSerpApiKey: ['SI_SERP_API_KEY', 'OPENSERP_API_KEY', 'OPEN_SERP_API_KEY'],
  siSerpDefaultEngine: ['SI_SERP_DEFAULT_ENGINE', 'OPENSERP_DEFAULT_ENGINE'],
...
const STORAGE_ALIASES = {
  ...
  siSerpBaseUrl: ['siSerpBaseUrl', 'openSerpBaseUrl', 'openserpBaseUrl'],
  siSerpApiKey: ['siSerpApiKey', 'openSerpApiKey', 'openserpApiKey'],
  siSerpDefaultEngine: ['siSerpDefaultEngine'],
  deeplKey: ['deeplKey'],
