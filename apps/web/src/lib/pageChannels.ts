...
export const PAGE_CHANNELS = {
  dashboard: [
    'get-dashboard-stats', 'get-live-feed', 'get-trending-topics', 'get-daily-social-trends', 'open-tiktok-trends-login', 'get-live-news', 'get-setup-status',
  ...
  onboarding: [
    ...
    'get-watched-monitors', 'save-watched-monitors', 'discover-keyword-targets',
    'get-auto-rules', 'save-auto-rules',
  ...
  accountHub: [
    ...
    'begin-platform-oauth', 'begin-browser-platform-connect', 'poll-platform-oauth',
    'finish-platform-oauth-connect', 'finish-browser-platform-connect',
    'use-selected-accounts', 'unlink-account',
