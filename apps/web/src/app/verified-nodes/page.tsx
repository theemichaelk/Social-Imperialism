...
export default function VerifiedNodesPage() {
  ...
  async function createCampaign() {
    ...
    setLoading(true);
    try {
      const res = await invoke<{ campaign: Campaign }>('create-verified-campaign', {
  ...
  return (
    <PageShell
      title="Verified Node Matrix"
      subtitle="15-platform discovery, 3-tier proof, and campaign kill-switch control"
